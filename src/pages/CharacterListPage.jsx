    ...
    return (
        <div className="main-container">
            ...
            <div className="main-container__search-wrapper">
                <img onClick={getSearchedCharacterList} class="main-container__search-wrapper__icon" 
                ...
                <input ref={searchInput} className="main-container__search-wrapper__input" placeholder="Search" type="text" onChange={e => setSearchTerm(e.target.value)}></input>
                <img style={clearIcon} onClick={handleClearSearch} class="main-container__search-wrapper__clear-icon" 
            ...
            characterList && characterList.length === 0 ?
                ...
                <div className="character-list-item__container">
                {
                    ...
                    // const id = character.url.replace("http://swapi.dev/api/people/", "").replace("/", "")
                        return (
